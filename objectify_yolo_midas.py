...
out1 = objectify.classify_request("Where is my water bottle?")
...
# The .names attribute contains a dictionary of class IDs and their names
class_names = yolo_model.names

# Print the full list of class names
print(class_names)
...
def fuse_yolo_midas(frame, out1):
...
async def detect(request: Request):
    ...
    objects, depth_map, frame_with_boxes = fuse_yolo_midas(frame, out1)
